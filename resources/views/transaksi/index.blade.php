        ...
        <div class="border border-primary col-md-12">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    @role('bendahara')
                        <div class="mb-2">
                            <a href="{{route('savings.anggota')}}" class="btn btn-outline-primary ">Tambah penarikan</a>
                        </div>
                    @endrole
                    <div>
                            ...
                            <tbody>
                                @foreach($transactions as $transaksi)
                                    <tr>
                                        ...
                                        @role('bendahara')
                                            <td>
                                                <a href="{{route('transaksi.cetak-bukti', $transaksi->id)}}" class="btn btn-primary btn-sm">Cetak Bukti</a>
                                            </td>
                                        @endrole
                                    </tr>
                                @endforeach
