    ...
    <div class="border border-primary col-md-12">
        ...
        @role('bendahara')
            <div class="card border-0">
                <div class="card-body">
                    <h6>Cari laporan</h6>
                    <form action="{{route('reports.installments')}}" method="get">
                        ...
                        <div class="d-flex">
                            <button class="btn btn-outline-primary">Cari laporan</button>
                            <a href="{{route('reports.all.installments')}}" class="btn btn-outline-primary ml-2">Cetak Semua Laporan</a>
                        </div>
                    </form>
                </div>
            </div>
